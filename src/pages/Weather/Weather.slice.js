...
export const weatherSelector = state => ({
    ...
    errorView: state.weather.errorView,
});
...
const weatherSlice = createSlice({
    ...
    reducers: {
        ...
        setErrorView: (state, action) => {
            state.errorView = action.payload
        }
    }
});

const { fetchWeatherDataSuccess, setErrorView } = weatherSlice.actions;

export const fetchWeatherData = () => async dispatch => {
    try {
        // const { list, city } = await apis.getWeather();
